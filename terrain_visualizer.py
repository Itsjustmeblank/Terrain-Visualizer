...
class TerrainVisualizer:
    ...
    def height_to_color(self, norm_height):             #height of verts to color
        ...
        return om.MColor([last_color[0], last_color[1], last_color[2], 1])      #if too high will just color with last rgb in the class
...
def apply(self):
    ...
    mesh.setColors(colors, self.color_set_name)                     #apply color to colorset
    mesh.assignColors(list(range(len(colors))), self.color_set_name)
    mesh.updateSurface()
